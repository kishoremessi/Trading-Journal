...
export default function TradeBook({ onTradeSaved }: TradeBookProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Save via backend proxy → Google Sheets (no CORS issues)
      ...
      if (!sheetsData.success) throw new Error(sheetsData.error || 'Google Sheets save failed');

      // Also save locally for Recent Trades panel
      try {
        ...
        <form onSubmit={editingId !== null ? handleUpdate : handleSubmit}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input type="number" name="buy" value={form.buy} onChange={handleChange}
            ...
            <div>
              ...
              <input type="number" name="sell" value={form.sell} onChange={handleChange}
