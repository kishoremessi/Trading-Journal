  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
      <div className="px-5 py-4 border-b border-gray-100 flex justify-between items-center text-center">
        ...
        <span className="text-[#000205] text-[13px] font-bold">{rows.length} months · most recent first</span>
      </div>
          ...
          return (
            <div key={key}
              ...
              <div className="text-center">
                ...
                <p className="text-[#00040a] text-center text-[12px] font-bold">{r.wins}W · {r.trades - r.wins}L</p>
              </div>
              <div className="text-right">
                {ds && ds.best !== -Infinity ? (
                  <span className="font-mono text-green-600 text-[16px] font-extrabold">
